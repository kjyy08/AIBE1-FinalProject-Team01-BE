package kr.co.amateurs.server.domain.like.repository;

import kr.co.amateurs.server.domain.like.model.dto.CommentLikeStatusDTO;
...
public interface LikeRepository extends JpaRepository<Like, Long> {
    ...
    @Query("SELECT new kr.co.amateurs.server.domain.like.model.dto.CommentLikeStatusDTO(c.id, " +
