...
import kr.co.amateurs.server.domain.together.repository.GatheringRepository;
...
import static kr.co.amateurs.server.domain.together.model.dto.GatheringPostResponseDTO.convertToDTO;
