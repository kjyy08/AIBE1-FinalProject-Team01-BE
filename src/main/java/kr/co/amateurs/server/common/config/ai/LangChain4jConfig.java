package kr.co.amateurs.server.common.config.ai;

import dev.langchain4j.model.chat.ChatLanguageModel;
import dev.langchain4j.model.googleai.GoogleAiGeminiChatModel;
import dev.langchain4j.service.AiServices;
import kr.co.amateurs.server.domain.ai.service.AiPostAnalysis;
import kr.co.amateurs.server.domain.report.service.llm.ReportAnalysis;
